        ...
        <div class="row">
            <div class="col-md-6 offset-md-3">
                <div class="text-center mb-4">
                    <img src="../public/img/fayez logo.png" alt="egyptlogo" style="max-width: 220px; margin-bottom: 20px;">
                </div>
                <!-- <h2 class="text-center mb-4">Fayez</h2>
                ...
                <div class="text-center mt-4">
                    ...
                    <p class="mt-3">Not a member yet? <a href="signup.php" class="signup-link">Sign up</a></p>
                </div>

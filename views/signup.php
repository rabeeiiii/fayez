        ...
        <div class="row">
            <div class="col-md-6 offset-md-3">
                <div class="text-center mb-4">
                    <img src="../public/img/fayez logo.png" alt="egyptlogo" style="max-width: 220px;">
                </div>
                ...
                <div class="text-center mt-4">
                    ...
                    <p class="mt-3">Already have an account? <a href="login.php" class="signup-link">Sign in</a></p>
                </div>
<!-- 
